...
public class Warrior : PlayerCombatAI
{
    
    //[SerializeField] GameObject passiveEffectPrefab; //TODO : 패시브 추가 할때 주석 해제
    //[SerializeField] Transform passiveSkillTransform;
    ...
    {
        base.OnCombatStart();
        //InitializeWithBaseInfo(baseInfo);
    }
    ...
    protected override void InitializeStates()
    {
        ...
        var skillState = new WarriorSkillState(this);
